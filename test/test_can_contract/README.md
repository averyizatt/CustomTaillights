These native tests check the firmware state encoder against the unchanged shared
CCM decoder and fixed wire bytes, temperature boundaries, percentage derating,
